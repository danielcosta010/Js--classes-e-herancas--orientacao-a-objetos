...
const aqueiroBruno = new Arqueiro('Bruno', 6, 8)

const aqueiroMagoAdão = new ArqueiroMago('Adão', 7, 7, 'Flecha e Fogo', 7, 8)

const guerrerioLeandro = new Guerreiro('Leandro', 8)
